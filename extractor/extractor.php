...
class Addons_extractor extends Interspire_Addons {
    ...
    function Install() {
        ...
        // $this -> Db -> Fetch ($quer);
         ...
         $quer =  $this -> Db -> Query ("CREATE TABLE IF NOT EXISTS ". SENDSTUDIO_TABLEPREFIX ."addons_extraction_historique (id int(11) NOT NULL AUTO_INCREMENT, timeStarted int(18), ,workStatus varchar(255),campagneName varchar(255), lastTimeUpdate int (11), type varchar (255), PRIMARY KEY (id))");
         if ($quer == false){
